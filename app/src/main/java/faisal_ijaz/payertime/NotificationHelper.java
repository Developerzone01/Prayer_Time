...
public class NotificationHelper extends ContextWrapper {
    public static final String alarmName = "Alarm alert";
    ...
    public android.support.v4.app.NotificationCompat.Builder getChannel(String title , String message){
        return new android.support.v4.app.NotificationCompat.Builder(getApplicationContext(), alarmName)
